...
The error is analyzed by creating a bias on diffusion coefficients, this can be done by `pydiffusion.utils.DCbias` function. Here is an example of creating bias at X = 0.2 in TiZr diffusion coefficients.
...
![DCbias](ErrorAnalysis_files/ErrorAnalysis_1.png)
...
![Error_low](ErrorAnalysis_files/ErrorAnalysis_2.png)
...
![Error_high](ErrorAnalysis_files/ErrorAnalysis_3.png)